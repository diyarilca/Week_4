...
public class SetMain {
   ...
   /* Set<String> set1 = new HashSet<String>();
    ...
    for (String s: set1){    karışık sıralar
        System.out.println(s);
        
    }
    System.out.println("LinkedHashSet*******************************");
    for (String s: set2){	ekleme sırasına göe sıralar
        System.out.println(s);
        
    }
    System.out.println("TreeSet*******************************");
    for (String s: set3){	alfabetik sıralar
        System.out.println(s);
        
    }*/
     //   System.out.println(set1.contains("Go")); olup olmadığına göre true
     //       System.out.println(set1.contains("Java"));  false döndürür
    	
    // System.out.println(set1.isEmpty()); içi boşsa true değilse false döndürür
        
   // set1.remove("Java"); silmek
    /*for (String s: set1){
        System.out.println(s);
